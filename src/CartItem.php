...
class CartItem implements Arrayable, Jsonable
{
     ...
     * @param array      $options
     */
    public function __construct($id, $name, $price, $weight = 0, $shipping = 0,$cuerrier_id = 0, array $options = [])
    {
        if (empty($id)) {
    ...
    public function updateFromArray(array $attributes)
    {
        ...
        $this->cuerrier_id = Arr::get($attributes, 'cuerrier_id', $this->cuerrier_id);
    ...
    public function __get($attribute)
    {
        ...
        if (config('cart.gross_price')) {
            switch ($attribute) {
                ...
                case 'shipping':
                    return  round($this->shipping, $decimals);
                case 'cuerrier_id':
                    return $this->cuerrier_id;
                case 'priceTotal':
    ...
    public static function fromArray(array $attributes)
    {
        ...
        return new self($attributes['id'], $attributes['name'], $attributes['price'], $attributes['weight'], $attributes['shipping'], $attributes['cuerrier_id'], $options);
    }
     ...
     * @return \Gloudemans\Shoppingcart\CartItem
     */
    public static function fromAttributes($id, $name, $price, $weight, $shipping, $cuerrier_id=0, array $options = [])
    {
        return new self($id, $name, $price, $weight, $shipping, $cuerrier_id, $options);
    }
